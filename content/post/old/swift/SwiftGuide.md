---
title: Swift 语言指南[转]
date: 2017-01-03 17:05:20
updated: 2017-01-23 18:33:57
comments: true
tags: [swift,iOS]
categories:
- 学习笔记
keywords: swift,iOS,swift
permalink: 
---
Swift 语言指南
===
...
## [教程文章](https://github.com/ipader/SwiftGuide/blob/master/Featured-Articles.md)


## [开源项目](https://github.com/ipader/SwiftGuide/blob/master/Featured.md)
...
* [Frabic](https://fabric.io)
* [fastlane]()
* [Xcode Server](https://support.apple.com/zh-cn/macos/server)


### 7. 开源项目
* [RESideMenu](https://github.com/romaonthego/RESideMenu)侧滑布局类库,支持左右滑动，滑动距离;
* [IQKeyboardManager](https://github.com/hackiftekhar/IQKeyboardManager)易于集成，支持设备的方向，可通过类的方法来启用和禁用键盘管理器；
* [ACPDownload](https://github.com/antoniocasero/ACPDownload)实现类似AppStore下载状态样式；
* [TCBlobDownload](https://github.com/thibaultCha/TCBlobDownload)支持后台线程执行大文件下载任务，暂停和重新恢复下载；
* [MobShareSDK](https://github.com/shingwasix/MobShareSDK)实现微信朋友，朋友圈分享;
* [BlocksKit](https://zwaldowski.github.io/BlocksKit)没有创建新的宏，函数，方法和类，仅对Cocoa基础类的一个扩展，是取代了通常的delegate用法;
* [SDWebImage](https://github.com/rs/SDWebImage)图片缓存的框架; 
* [MJRefresh](https://github.com/CoderMJLee/MJRefresh)下拉刷新上拉加载更多MJRefresh类库;
* [Toast](https://github.com/scalessec/Toast)Android风格的Toast控件,用户提示便捷得体；
* [IQLabelView](https://github.com/kcandr/IQLabelView)对文本控件覆盖，缩放和旋转；
* [AFNetworking](https://github.com/AFNetworking/AFNetworking)
* [RestKit](https://github.com/RestKit/RestKit)处理web服务api,解析JSON映射响应对象；
* [Masonry](https://github.com/Masonry/Masonry)一个轻量级的布局框架,拥有自己的描述语法，采用更优雅的链式语法封装自动布局；


*[Perfect 服务器](https://github.com/PerfectlySoft/Perfect/blob/master/README.zh_CN.md)
